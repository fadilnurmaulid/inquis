 ...
 * Roadmap notice for admin routes (product-vision.md).
 */
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-6 rounded-2xl border bg-white p-10 text-center shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-md text-muted-foreground">
            Modul admin untuk manajemen konten, analitik, dan pengguna sedang
            dalam tahap pengembangan sebagai bagian dari roadmap INQUIS.
          </p>
        </div>
